...
class AttentionPooling(nn.Module):
    ...
    def forward(self, x: torch.Tensor, return_weights: bool = False) -> Union[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        """
...
def create_covid19_classifier(**kwargs) -> COVID19Classifier:
    """Factory function to create COVID19 classifier"""
    return COVID19Classifier(**kwargs)


__all__ = ['COVID19Classifier', 'SliceEncoder', 'AttentionPooling', 'create_covid19_classifier']